...
execute store result score _ Rotation run data get entity @a[team=Active,scores={Leader=0},limit=1] Rotation[0] 1

scoreboard players operation $Choice Rotation = _ Rotation
scoreboard players operation $Choice Rotation -= @a[team=Active,scores={Leader=0},limit=1] Rotation
...
execute if score $Choice Rotation matches 8.. run scoreboard players set _ Choice -1
execute unless score $Choice Rotation matches -7..7 run scoreboard players operation @a[team=Active,scores={Leader=0},limit=1] Rotation = _ Rotation
